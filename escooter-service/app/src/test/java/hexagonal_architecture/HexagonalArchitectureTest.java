...
class HexagonalArchitectureTest {
    ...
    public void hexagonalArchitectureRule() {
        ...
        ArchRule ruleLayered = onionArchitecture()
                .domainModels("..hexagonal_architecture.domain_layer.model..")
                .domainServices("..hexagonal_architecture.domain_layer.service..")
                .applicationServices("..hexagonal_architecture.application_layer..")
                //.adapter("cli", "..adapter.cli..")
                .adapter("persistence", "..hexagonal_architecture.infrastructure_layer.persistence..")
                .adapter("rest", "..hexagonal_architecture.infrastructure_layer.rest..");
        // TODO hexagonal_architecture.infrastructure_layer
